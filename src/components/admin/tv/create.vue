  ...
  <div class="kkz-admin-tv-create">
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
      ...
      <Form-item label="国家" prop="country">
        <Input v-model="formValidate.country" placeholder="请输入发行的国家"></Input>
      </Form-item>
...
<script>
  ...
  import {getStarList,getTagList,postTvList} from 'api/tv';
