    ...
    <div class="main w flex-row-between">
      <div class="main-left">
        ...
        <div class="kkz-movie">
          ...
          <header-title headerTitle="全部电影" ></header-title>
          <ul class="clearfix">
            ...
            <li :class="{ ' no-margin-right' : (index+1)%4 === 0}" class="all-anime-item" style="float: left">
              <image-title-rate   width="100%" imgHeight="222.88px"
