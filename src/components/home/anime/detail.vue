    ...
    <div class="w">
      <div class="flex-row-between  title">
        ...
        <div>
          <Breadcrumb separator="/">
            ...
            <Breadcrumb-item href="/anime">
              视频
            </Breadcrumb-item>

            <Breadcrumb-item :href="'/anime/' + data.id">
              {{data.title}}
            </Breadcrumb-item>
      ...
      <div class="file-info clearfix">
        ...
        <template v-for="(item,index) in data.files">
          <a :href="'/#/anime/detail/' + data.id + '?file=' + index" :class="{active: index == file}" class="file float-left"
...
<script>
  import {getShowAnimeList} from 'api/anime'
  export default {
    data() {
      return {
        isCloseLight: false,
